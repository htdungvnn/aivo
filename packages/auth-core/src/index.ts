 ...
 * import { requireAuth, requireRole } from '@repo/auth-core/middleware';
 * import { JWTService } from '@repo/auth-core/jwt';
 * import { AUTH_ERROR_CODES } from '@repo/auth-core/types';
 * 
 * @example
 * // Import everything
 * import {
