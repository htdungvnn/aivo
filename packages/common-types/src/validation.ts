 ...
 * 
 * @module @repo/common-types/validation
 */
 ...
 * @example
 * ```typescript
 * import { isFiniteNumber } from '@repo/common-types/validation';
 ...
 * @example
 * ```typescript
 * import { clamp } from '@repo/common-types/validation';
 * clamp(150, 0, 100); // 100
 * clamp(-5, 0, 100); // 0
 * clamp(50, 0, 100); // 50
 * ```
 ...
 * @example
 * ```typescript
 * import { roundTo } from '@repo/common-types/validation';
 ...
 * @example
 * ```typescript
 * import { isValidEmail } from '@repo/common-types/validation';
 ...
 * @example
 * ```typescript
 * import { isValidUrl } from '@repo/common-types/validation';
 ...
 * @example
 * ```typescript
 * import { safeJsonParse } from '@repo/common-types/validation';
