 ...
 * @example
 * ```typescript
 * import { formatDate } from '@aivo/common-types/date';
 ...
 * @example
 * ```typescript
 * import { parseDate } from '@aivo/common-types/date';
 ...
 * @example
 * ```typescript
 * import { getDateRange } from '@aivo/common-types/date';
