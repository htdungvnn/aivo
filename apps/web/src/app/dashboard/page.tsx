        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center gap-3">
              ...
              <span className="hidden sm:inline px-3 py-1 text-xs font-medium bg-cyan-500/10 text-cyan-400 rounded-full border border-cyan-500/20">
                PRO
              </span>
            </div>
        ...
        >
          {[
            ...
            <motion.div
              ...
              className="bg-slate-900/60 backdrop-blur-sm rounded-xl p-5 border border-slate-800/50 hover:border-slate-700/50 transition-all"
            >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <motion.div
              ...
              animate="visible"
              variants={fadeInUp}
              className="bg-gradient-to-br from-blue-900/30 via-slate-900/60 to-purple-900/30 rounded-xl p-6 border border-blue-500/20"
            >
            ...
            <motion.div
              ...
              animate="visible"
              variants={fadeInUp}
              className="bg-slate-900/60 backdrop-blur-sm rounded-xl p-6 border border-slate-800/50"
            >
          ...
          <div className="space-y-6">
            ...
            <motion.div
              ...
              animate="visible"
              variants={fadeInUp}
              className="bg-gradient-to-br from-amber-900/20 via-slate-900/60 to-orange-900/20 rounded-xl p-6 border border-amber-500/20"
            >
              <div className="flex items-center gap-3 mb-4">
